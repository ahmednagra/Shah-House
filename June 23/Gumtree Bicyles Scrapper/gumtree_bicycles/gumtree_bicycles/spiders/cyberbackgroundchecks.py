...
class CyberbackgroundchecksSpider(Spider):
    ...
    custom_settings = {
        ...
        'FEEDS': {
            f'output/CyberBackgroundChecks Records.csv': {
                'format': 'csv',
    ...
    def start_requests(self):
        for address in self.get_search_addresses()[:5]:
    ...
    def get_search_addresses(self):
        with open('us_addresses.csv', mode='r', encoding='utf8') as input_file:
